...
Action Command_ResetMyRank(int client, int args)
{
	if(!IsValidClient(client, true, true))
	{
		return;
...
Action Command_MyStats(int client, int args)
{
	if(!IsValidClient(client, true, true))
	{
		return;
	...
	static char name[MAX_NAME_LENGTH + 2];
	char buffer[512];
...
Action Command_ResetRank_All(int client, int args)
{
	if(!IsValidClient(client, true, true))
	{
...
Action Command_TopInfectedHumans(int client, int args)
{
	int num;
...
Action Command_TopZombieKills(int client, int args)
{
	int num;
...
Action Command_TopWinRounds_Human(int client, int args)
{
	int num;
...
Action Command_TopWinRounds_Zombie(int client, int args)
{
	int num;
...
int Menu_ResetData_Handler(Menu menu, MenuAction action, int client, int choice)
{
...
int Menu_Nothing_Handler(Menu menu, MenuAction action, int client, int choice)
{
